...
$PDO = db_connect();
$sql = "SELECT tipo_evento, data_evento, prof_eventos, descricao_evento, nome FROM tb_eventos INNER JOIN tb_cliente ON tb_eventos.id_cliente = tb_cliente.id_cliente WHERE id_eventos = :id_eventos";
                ...
                <header class="header-desktop">
                    ...
                    <div class="main-content">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="nome" disabled=""  id="nome_Cliente" class="form-control cc-exp" value="<?php echo $user['nome'] ?>"  placeholder="Insira o nome completo">
                         </div>
                      </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-6">
                                                    <select name="tipo_evento" id="" required=""  class="validate[required] form-control">
                                            ...
                                            <div class="col-6">
                                            <input class="form-control" type="date"  name="data_evento" required=""  value="<?php echo $user['data_evento'] ?>" id="example-date-input">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <input type="text" id="password-input" value="<?php echo $user['prof_eventos'] ?>" name="prof_eventos" placeholder="Fotógrafos" class="form-control">
                                      ...
                                      <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input name="descricao_evento" value="<?php echo $user['descricao_evento'] ?>" id="textarea-input"  rows="9" placeholder="Detalhes importantes, ex: Levar lente 50mm.." class="form-control"></input>
                                        </div>
