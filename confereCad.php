                    ...
                    <div class="row">
                     ...
                     <select name="estado" > 
                        ...
                        <div class="form-actions no-margin-bottom">
                             ...
                             <a href="novoEvento.php"> <button type="submit" class="btn btn-warning"   name="btnCancelar">< Voltar </button></a>
                             <a href="continuacaoEvento.php"><button type="Submit" class="btn btn-success" name="btnalterar">Próximo></button></a>
